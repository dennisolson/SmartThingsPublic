...
metadata {
	definition (name: "SmartSense Motion Sensor", namespace: "smartthings", author: "SmartThings") {
        ...
        fingerprint inClusters: "0000,0001,0003,0402,0500,0020,0B05", outClusters: "0019", manufacturer: "CentraLite", model: "3326-L",deviceJoinName: "Dennis Motion Sensor"
	}
...
def configure() {
	...
	def configCmds = [
		...
		"send 0x${device.deviceNetworkId} 1 ${endpointId}", "delay 200",
